...
dir.create("2 Corlist", recursive = TRUE, showWarnings = FALSE)
...
macro <- qs_read("macro.qs", nthreads = 6)

cat("DefaultAssay：", DefaultAssay(macro), "\n")
...
options(
  future.globals.maxSize = 30 * 1024^3
)
